(function (root, factory) {
  ...
  const SOURCES = Object.freeze({
    GDELT: { owner:'GDELT Project', url:'https://data.gdeltproject.org/gdeltv3/gal/feed.rss', type:'news discovery', coverage:'global, multilingual sampled article titles', freshness:'rolling 15-minute feed', auth:'none', license:'GDELT data free for commercial use with citation; original publishers retain article rights', attribution:'GDELT discovery and original publisher link', limitations:'Bounded title-category sample; feed time is observation, not necessarily publication; article signal is not verified event fact', enabled:true },
