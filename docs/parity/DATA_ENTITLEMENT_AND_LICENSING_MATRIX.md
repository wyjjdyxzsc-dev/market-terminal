...
- Source commit `ebacf62` production-verifies engineering availability with all seven `20260804d` assets, `34/34` contracts, mixed-provider ticker fallback, and bounded SPCX chain data. It does not establish exchange-grade timeliness, completeness, redistribution rights, or Bloomberg parity. FT-008 remains partial.
